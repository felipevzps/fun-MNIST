...
W1, b1, W2, b2 = gradient_descent(X_train, Y_train, 0.10, 1000)        # run again to train W and b
#print(f"W1: {W1}, b1: {b1}, W2: {W2}, b2: {b2}")
save_params(W1, b1, W2, b2, 'model/nn_parameters.npz')                # run again to update parameters
